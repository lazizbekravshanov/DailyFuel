...
| Base map on `/map` | [OpenStreetMap](https://www.openstreetmap.org/copyright) standard tiles from `tile.openstreetmap.org`, under the [tile usage policy](https://operations.osmfoundation.org/policies/tiles/); or, when the build has `CARTO_BASEMAPS_KEY` set (a free key from [carto.com/basemaps/apikey](https://carto.com/basemaps/apikey/)), [CARTO](https://carto.com/attributions)'s light basemap from `a.basemaps.cartocdn.com` | © OpenStreetMap contributors (ODbL); © CARTO when CARTO's tiles are used |
